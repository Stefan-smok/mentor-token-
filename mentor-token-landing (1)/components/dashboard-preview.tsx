  ...
  return (
    <>
      ...
      <section className="bg-white py-8 relative overflow-hidden">
        {/* Productivity Illustration - Positioned to be visible */}
        ...
        {/* Dashboard Mockup with Blue Outline */}
            ...
            <div className="flex h-[600px]">
              ...
              <div className="flex-1 p-6 relative">
                ...
                <div className="space-y-3 mb-6">
                  {/* Mentor 1: Kierra Press (2.5 stars) */}
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-1 mb-1">
                            <StarIcon />
                            <StarIcon />
                            {/* Half star for Kierra Press - using a full star for simplicity as per previous instruction */}
                            <StarIcon />
                  ...
                  {/* Mentor 2: Alison Vetrovs (5 stars) */}
                  <Card className="p-4 border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <Image
                  ...
                  {/* Mentor 3: Marcus Carder (4 stars) */}
                  <Card className="p-4 border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <Image
